...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label0.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label1.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label2.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label3.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label4.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label5.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label6.setFont(QFont("Arial", 50, QFont.Bold))
        ...
        self.label7.setFont(QFont("Arial", 50, QFont.Bold))
